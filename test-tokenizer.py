...
tokenizer = tkn.Tokenizer(test_str_0)
while (token := tokenizer.nextToken()).type != tkn.Token_Type.EOF:
    print(token.type)
    print(token.value)

tokenizer = tkn.Tokenizer(test_str_1)
while (token := tokenizer.nextToken()).type != tkn.Token_Type.EOF:
    print(token.type)
    print(token.value)

tokenizer = tkn.Tokenizer(test_str_2)
while (token := tokenizer.nextToken()).type != tkn.Token_Type.EOF:
    print(token.type)
    print(token.value)

tokenizer = tkn.Tokenizer(test_str_3)
while (token := tokenizer.nextToken()).type != tkn.Token_Type.EOF:
    print(token.type)
    print(token.value)